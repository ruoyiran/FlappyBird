...
namespace UTJ.FrameCapturer
{
    ...
    public class MovieEncoderConfigs
    {
        ...
        public fcAPI.fcPngConfig frameEncoderSettings = fcAPI.fcPngConfig.default_value;
    ...
    public abstract class MovieEncoder : EncoderBase
    {
        ...
        public static MovieEncoder Create(Type t)
        {
            switch (t)
            {
                ...
                case Type.Frame: return new FrameEncoder();
            }
            return null;
        }
